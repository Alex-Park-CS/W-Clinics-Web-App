// Inez
    ...
    .then(() => {
        // Now, check for the current user
        var user = firebase.auth().currentUser;
        if (user) {
            // Continue with your code
        } else {
    ...
    function displayAppointmentInfo() {
        ...
        db.collection("user-info").add({
            ...
            userGenderFemale: userGenderFemaleAppmt,
            userGenderMale: userGenderMaleAppmt,
            userGenderOther: userGenderOtherAppmt,
            userContactMethodEmail: userContactMethodEmailAppmt,
            userContactMethodPhone: userContactMethodPhoneAppmt,
            userAppmntDate: userDateAppmt,
            userAppmntTime: userTimeAppmt,
            userAppmntDetail: userSpecialRequestAppmt,
